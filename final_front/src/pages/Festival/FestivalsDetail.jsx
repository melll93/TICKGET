...
console.log(festival.festMId)
    ...
    const reduxUser = useSelector(state => state.userStatus.user);
    console.log(reduxUser)
>>>>>>> 94d1cd4fd70b8628ce2db1ff3125dacb9478232b
...
<<<<<<< HEAD
   ...
   */}
        <div>
          <BButton
            style={{ width: "200px", height: "38px", backgroundColor: "black" }}
              ...
              <div className="product_detail_info">
                ...
                <ul className="product_lnfo_list_col2">
                  <li className="product_info_list">
                    ...
                    <div className="product_info_desc">fest_location</div>
                  </li>
                  <li className="product_info_list">
