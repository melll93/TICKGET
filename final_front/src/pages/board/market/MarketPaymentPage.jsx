  ...
  useEffect(() => {
    const boardDetail = async () => {
      ...
      setMkpDetails({
        ...
        mk_ticket_price:
          jsonDoc[0].mkTicketPrice.toLocaleString() /* 결제 금액 (쉼표붙임->문자열) */,
        ticketPrice:
          jsonDoc[0].mkTicketPrice /* 토스페이먼츠로 넘길 금액 (숫자형) */,
      });
    };
    boardDetail();
  }, []);
    ...
    <>
      ...
      <div className="center">
        ...
        <div
          ...
          style={{ display: "center", margin: "80px 150px 150px 150px" }}
        >
          ...
          <div style={{ marginTop: "5px" }}>
            ...
            {/*  결제 정보 섹션  */}
            <h3 style={{ fontWeight: "bold", marginTop: "80px" }}>
              ◽결제 정보
            </h3>
            <section style={{ justifyContent: "space-between" }}>
                ...
                <Card.Body style={{ display: "flex", alignItems: "center" }}>
                  <div style={{ marginLeft: "20px" }}>
                    ...
                    <div>
                      ...
                      >
                        결제 금액{" "}
                        <span style={{ marginLeft: "320px", color: "red" }}>
                          {mkpDetail.mk_ticket_price} 원
                        </span>
                      </Card.Title>
                    </div>
                    <hr style={{ opacity: "0.0" }} />
              ...
              <div>
                <Button style={{ width: "400px" }} onClick={handleClick}>
                  토스 결제하기
                </Button>
                {/* <PaymentComponent /> */}
                ...
                <Button
                  style={{ width: "400px" }}
                  onClick={() => navigate(`../market/mk_boardDetail?no=${loc}`)}
                >
                  취소/이전으로
                </Button>
              </div>
